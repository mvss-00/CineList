      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-[#e5e7eb] p-8 space-y-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-[#1a1a1a] tracking-tight">Создать аккаунт</h1>
            <p className="mt-1 text-sm text-[#6b7280]">Начните вести свой кинодневник</p>
          </div>
          ...
          <p className="text-center text-sm text-[#6b7280]">
            Уже есть аккаунт?{" "}
            <Link href="/auth/login" className="text-[#e11d2a] font-medium hover:underline">
              Войти
            </Link>
          </p>
        </div>
